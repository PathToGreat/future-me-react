...
export default function App() {
  ...
  const currentAvatarUrl = "https://images.unsplash.com/photo-1615544983151-5fea32cb8584?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&h=1080&ixid=MnwxfDB8MXxyYW5kb218MHx8cGVyc29ufHx8fHx8MTcxMzc1MjIyNg&ixlib=rb-4.0.3&q=80&w=720";
  const futureAvatarUrl = "https://images.unsplash.com/photo-1615544983151-5fea32cb8584?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&h=1080&ixid=MnwxfDB8MXxyYW5kb218MHx8cGVyc29ufHx8fHx8MTcxMzc1MjIyNg&ixlib=rb-4.0.3&q=80&w=690";
  ...
  const renderProjectedChanges = () => {
    ...
    const changes = [
      ...
      { type: 'health', text: 'Better skin elasticity and complexion', icon: '✨' },
      ...
      <View style={styles.changesContainer}>
        ...
        <View style={styles.changesList}>
          {changes.map((change, index) => (
            <View key={index} style={[styles.changeItem, styles[`${change.type}Change`]]}>
              <View style={[styles.changeIcon, { backgroundColor: getCategoryColor(change.type === 'health' ? CATEGORIES.HEALTH : change.type === 'fitness' ? CATEGORIES.FITNESS : CATEGORIES.MENTAL) }]}>
    ...
    <ScrollView style={styles.tabContent}>
      <View style={styles.sectionContainer}>
        ...
        <Text style={styles.sectionDescription}>
          Based on your habit consistency, here's a visualization of how you might look over time:
        </Text>
            ...
            >
              <Text 
                style={[
                  ...
                  selectedTimeframe === days && styles.timeframeButtonTextActive
                ]}
              >
  ...
  const renderHabits = () => (
    <ScrollView style={styles.tabContent}>
      <View style={styles.sectionContainer}>
        ...
        <Text style={styles.sectionDescription}>
          Track your progress with these key habits to transform your future self:
        </Text>
            ...
            <View key={index} style={styles.habitCard}>
              ...
              <View style={[
                styles.habitCompletionCircle,
                {
                  ...
                  borderColor: index % 3 === 0 ? '#4CAF50' : index % 3 === 1 ? '#2196F3' : '#E91E63'
                }
              ]}>
                <Text style={[
                  styles.habitCompletionText,
                  {color: index % 3 === 0 ? '#4CAF50' : index % 3 === 1 ? '#2196F3' : '#E91E63'}
                ]}>
        ...
        <View style={styles.quickHabitsContainer}>
          ...
          {preloadedHabits.slice(0, 5).map((habit, index) => (
            <View key={index} style={styles.quickHabitItem}>
              <View style={[styles.checkboxContainer, index < 3 && styles.checkboxChecked]}>
                <Text style={[styles.checkboxIcon, index < 3 && styles.checkboxIconChecked]}>
                  {index < 3 ? '✓' : ''}
                </Text>
              </View>
              <View style={styles.quickHabitDetails}>
                <Text style={styles.quickHabitTitle}>{habit.title}</Text>
                <Text style={styles.quickHabitDescription}>{habit.description}</Text>
              </View>
            </View>
          ))}
        </View>
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.bottomNav}>
        ...
        >
          ...
          <Text style={[styles.navText, activeTab === 'dashboard' && styles.navTextActive]}>Daily</Text>
        </TouchableOpacity>
        ...
        >
          <Text style={styles.navIcon}>🔄</Text>
          <Text style={[styles.navText, activeTab === 'habits' && styles.navTextActive]}>Habits</Text>
        </TouchableOpacity>
        
        <TouchableOpacity 
          style={[styles.navItem, activeTab === 'future' && styles.navItemActive]}
          onPress={() => setActiveTab('future')}
        >
          <Text style={styles.navIcon}>🔮</Text>
          <Text style={[styles.navText, activeTab === 'future' && styles.navTextActive]}>Future</Text>
        </TouchableOpacity>
