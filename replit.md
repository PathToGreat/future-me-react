...
-   **Ghost Silhouette Removal + Long Hair Face Fix:** Eliminates a faint ghost outline from the avatar rendering and fixes long hair occlusion of the face by splitting hair into back and crown layers.
